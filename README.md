...
- **Три уровня сложности**:
  ...
  - **Уровень B**: CLI и скрипты для продвинутых(пока работают только через GUI)
  - **Уровень C**: Инфраструктурные задачи для администраторов (в разработке)
...
- ✅ 8 миссий (5 уровня A, 3 уровня B)
...
### Уровень C (2 миссии, планируются) 
- Настройка firewall
